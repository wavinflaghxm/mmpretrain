...
OBJECTS365V2_CATEGORIES = (
    ...
    'Pot', 'Cow', 'Cake', 'Dining Table', 'Sheep', 'Hanger',
    ...
    'Nightstand', 'Teapot', 'Telephone', 'Trolley', 'Head Phone',
    ...
    'Heavy Truck', 'Hamburger', 'Extractor', 'Extension Cord', 'Tong',
